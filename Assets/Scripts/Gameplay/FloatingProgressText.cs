...
public class FloatingProgressText : MonoBehaviour
{
    public float floatSpeed = 1.0f; // Скорость движения текста вверх
    public float fadeSpeed = 0.5f;  // Скорость исчезновения текста
    ...
    private void Update()
    {
        ...
        transform.position += Vector3.right * floatSpeed* 0.5f * Time.deltaTime;
